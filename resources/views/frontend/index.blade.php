												...
												<div class="home-slider-container">
													...
													<div class="home-slider-desc">
														<div class="home-slider-title mb-4">
															...
															<span class="trending">{{$product->product_name}}</span>
														</div>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-6">
							<div class="product_grid card b-0">
								...
								<div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
									<div class="text-left">
										<div class="text-left">
											<div class="elso_titl"><span class="small">{{$product->rel_to_subcategory->subcategory_name}}</span></div>
											...
											<div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">
												...
												<div class="ml-2">
													<a href="{{route('wish',$product->id)}}"><i style="font-size: 20px;"onmouseover="this.style.color='red'"
 														onmouseout="this.style.color='#000'" class="far fa-heart"></i></a>
												</div>
											</div>
											<div class="elis_rty"><span class="ft-bold text-dark fs-sm">
												@if ($product->discount)
													
												<del class="text-danger">Tk{{$product->product_price}}</del> 
												@endif
												 TK {{$product->after_discount}}</span></div>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="ftr-content">
								...
								@foreach ($best_sellings as $best)
									...
									<div class="col-xl-4 col-lg-5 col-md-5 col-4">
										<div class="shop_thumb position-relative">
											<a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img class="card-img-top" src="{{asset('uploads/preview')}}/{{$best->rel_to_product->preview}}" alt="..."></a>
										</div>
									</div>
									<div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0 mt-3">
										<div class="text-left mfliud">
											<h5 class="fs-md mb-0 lh-1 mb-1 ft-medium"><a href="shop-single-v1.html">{{$best->rel_to_product->product_name}}</a></h5>
											<div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">
												<i class="fas fa-star filled"></i>
												<i class="fas fa-star filled"></i>
												<i class="fas fa-star filled"></i>
											...
											<div class="elis_rty"><span class="ft-bold text-dark fs-sm"><i class="fa-solid fa-bangladeshi-taka-sign"></i> {{$best->rel_to_product->after_discount}}</span></div>
										</div>
									</div>
									</div>
								@endforeach
							...
							<div class="ftr-content">
								...
								@foreach ($new_arrivals as $arrival)
									<div class="product_grid row">
										<div class="col-xl-4 col-lg-5 col-md-5 col-4">
											<div class="shop_thumb position-relative">
												<a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img class="card-img-top" src="{{asset('uploads/preview')}}/{{$arrival->preview}}" alt="..."></a>
											</div>
										</div>
										<div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
											<div class="text-left mfliud">
												<div class="elso_titl"><span class="small">{{$arrival->rel_to_subcategory->subcategory_name}}</span></div>
												<h5 class="fs-md mb-0 lh-1 mb-1 ft-medium"><a href="shop-single-v1.html">{{$arrival->product_name}}</a></h5>
												<div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">
													<i class="fas fa-star filled"></i>
													<i class="fas fa-star filled"></i>
													<i class="fas fa-star filled"></i>
												...
												<div class="elis_rty"><span class="ft-bold text-dark fs-sm"><i class="fa-solid fa-bangladeshi-taka-sign"></i> {{$arrival->after_discount}}</span></div>
											</div>
										</div>
									</div>
								@endforeach
							...
							<div class="ftr-content">
								...
								@foreach ($all_recent_product as $recent)
									<div class="product_grid row">
										<div class="col-xl-4 col-lg-5 col-md-5 col-4">
											<div class="shop_thumb position-relative">
												<a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img class="card-img-top" src="{{asset('uploads/preview')}}/{{$recent->preview}}" alt="..."></a>
											</div>
										</div>
										<div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
											<div class="text-left mfliud">
												<div class="elso_titl"><span class="small">{{$recent->rel_to_subcategory->subcategory_name}}</span></div>
												<h5 class="fs-md mb-0 lh-1 mb-1 ft-medium"><a href="shop-single-v1.html">{{$recent->product_name}}</a></h5>
												<div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">
													<i class="fas fa-star filled"></i>
													<i class="fas fa-star filled"></i>
													<i class="fas fa-star filled"></i>
												...
												<div class="elis_rty"><span class="ft-bold text-dark fs-sm"><i class="fa-solid fa-bangladeshi-taka-sign"></i> {{$recent->after_discount}}</span></div>
											</div>
										</div>
									</div>
								@endforeach
