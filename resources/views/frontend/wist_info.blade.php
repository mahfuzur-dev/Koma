                        ...
                        <div class="dashboard_author px-2 py-5">
                         ...
                         <div class="dashboard_author">
                              ...
                              <ul class="dahs_navbar">
                                   ...
                                   <li><a href="{{route('wish.info')}}" class="active"><i class="lni lni-heart mr-2"></i>Wishlist</a></li>
                         ...
                         @foreach ($all_wishes as $wish)
                             <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                              <div class="product_grid card b-0">
                                   ...
                                   <a href="{{route('delete.wish',$wish->id)}}" class="btn btn_love position-absolute ab-right theme-cl"><i class="fas fa-times"></i></a> 
                                   <div class="card-body p-0">
                                        <div class="shop_thumb position-relative">
                                             <a class="card-img-top d-block overflow-hidden" href="{{route('product.details',$wish->rel_to_product->slug)}}"><img class="card-img-top" src="{{asset('uploads/preview')}}/{{$wish->rel_to_product->preview}}" alt="..."></a>
                                        </div>
                                   </div>
                                   <div class="card-footers b-0 pt-3 px-2 bg-white d-flex align-items-start justify-content-center">
                                        <div class="text-left">
                                             <div class="text-center">
                                                  ...
                                                  <div class="elis_rty"><span class="ft-bold fs-md text-dark"><i class="fa-solid fa-bangladeshi-taka-sign"></i> {{$wish->rel_to_product->after_discount}}</span></div>
                                             </div>
                                        </div>
                                   </div>
                              </div>
