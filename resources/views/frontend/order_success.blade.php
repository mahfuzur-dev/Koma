          ...
          <div class="row justify-content-center">
               <div class="col-12 col-md-10 col-lg-8 col-xl-6 text-center">
                    ...
                    @if (session('order_success'))
                         ...
                         <h2 class="mb-2 ft-bold">{{session('order_success')}}</h2>
                    @endif
                    <!-- Text -->
                    <p class="ft-regular fs-md mb-5">Your order has been completed. Your order details are shown for your personal accont.</p>
                    <!-- Button -->
